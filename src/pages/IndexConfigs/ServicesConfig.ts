...
export const ServicesConfig: IIcons[] = [
  {
    id: 1,
    icon: 'view_in_ar',
    text_color: 'white',
    ...
    content: {
      title: 'Projetos 3D',
      img: 'public/img/img-3D.svg',
      textExplanation:
        'Damos vida às suas ideias com projetos 3D de alta precisão, riqueza de detalhes e um nível de personalização que atende às suas necessidades específicas. Utilizamos as melhores ferramentas de modelagem e visualização para criar representações realistas e funcionais, garantindo um planejamento eficiente que permite ajustes em tempo real e promove total transparência em cada etapa. Nossa expertise está focada em transformar sua visão em realidade, com qualidade excepcional, segurança garantida e um processo livre de surpresas, fornecendo a confiança necessária para o sucesso do seu projeto.',
    },
  },
  {
    id: 2,
